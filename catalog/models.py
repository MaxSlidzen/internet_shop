...
class Product(models.Model):
    ...
    created_at = models.DateField(auto_now=False, auto_now_add=True, verbose_name='создан')
    changed_at = models.DateField(auto_now=True, auto_now_add=False, **NULLABLE, verbose_name='изменен')
